...
- Create Angular project with ng: `ng new company-template-angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`company-template-angular.client.esproj`).
